...
int main(int argc, char* argv[]) {
	...
	auto _ = bserv::server{ config, {
		...
		bserv::make_path("/users", &view_users,
			...
			bserv::placeholders::response,
			std::string{"1"}),
		bserv::make_path("/search_", &normal_view_users_restrict,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			std::string{"1"},
			bserv::placeholders::json_params),
		bserv::make_path("/search", &admin_view_users_restrict,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			std::string{"1"},
			bserv::placeholders::json_params),
		bserv::make_path("/buildings", &view_buildings,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			std::string{"1"}),
		bserv::make_path("/inspections", &view_inspections,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			std::string{"1"}),
		bserv::make_path("/my_inspections", &view_my_inspections,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			std::string{"1"}),
		bserv::make_path("/users/<int>", &view_users,
			...
			bserv::placeholders::response,
			bserv::placeholders::_1),
		bserv::make_path("/my_inspections/<int>", &view_my_inspections,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::_1),
		bserv::make_path("/inspections/<int>", &view_inspections,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::_1),
		bserv::make_path("/search_/<int>", &normal_view_users_restrict_save,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::_1),
		bserv::make_path("/search/<int>", &admin_view_users_restrict_save,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::_1),
		bserv::make_path("/inspections_", &admin_view_inspections_restrict,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			std::string{ "1" },
			bserv::placeholders::json_params),
		bserv::make_path("/inspections_/<int>", &admin_view_inspections_restrict_save,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::_1),
		bserv::make_path("/edit", &admin_view_inspections_edit_restrict,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			std::string{ "1" },
			bserv::placeholders::json_params),
		bserv::make_path("/edit/<int>", &admin_view_inspections_edit_restrict_save,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::_1),
		bserv::make_path("/buildings/<int>", &view_buildings,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session,
			bserv::placeholders::response,
			bserv::placeholders::_1),
		bserv::make_path("/form_add_user", &form_add_user,
			...
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/form_apply", &form_apply,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/form_update_user", &form_update_user,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/form_update_self", &form_update_self,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/form_delete_user", &form_delete_user,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/form_delete_inspection", &form_delete_inspection,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/form_delete_my_inspection", &form_delete_my_inspection,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/form_update_inspection", &form_update_inspection,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
			bserv::placeholders::session),
		bserv::make_path("/form_update_my_inspection", &form_update_my_inspection,
			bserv::placeholders::request,
			bserv::placeholders::response,
			bserv::placeholders::json_params,
			bserv::placeholders::db_connection_ptr,
